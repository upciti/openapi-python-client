...
from .api import default, parameters, tests
...
class DefaultApi:
    ...
    async def get_common_parameters_detailed(
        self,
        *,
        common: Union[Unset, str] = UNSET,
    ) -> Response[None]:
        client = self._client
        return await default.get_common_parameters.asyncio_detailed(
            client=client,
            common=common,
        )

    async def post_common_parameters_detailed(
        self,
        *,
        common: Union[Unset, str] = UNSET,
    ) -> Response[None]:
        client = self._client
        return await default.post_common_parameters.asyncio_detailed(
            client=client,
            common=common,
        )


class SyncDefaultApi:
    def __init__(self, client: InnerClient):
        self._client = client

    def get_common_parameters_detailed(
        self,
        *,
        common: Union[Unset, str] = UNSET,
    ) -> Response[None]:
        client = self._client
        return default.get_common_parameters.sync_detailed(
            client=client,
            common=common,
        )

    def post_common_parameters_detailed(
        self,
        *,
        common: Union[Unset, str] = UNSET,
    ) -> Response[None]:
        client = self._client
        return default.post_common_parameters.sync_detailed(
            client=client,
            common=common,
        )
...
class ParametersApi:
    ...
    async def get_same_name_multiple_locations_param_detailed(
        self,
        *,
        ...
        client = self._client
        return await parameters.get_same_name_multiple_locations_param.asyncio_detailed(
            client=client,
...
class SyncParametersApi:
    def __init__(self, client: InnerClient):
        self._client = client

    def get_same_name_multiple_locations_param_detailed(
        self,
        *,
        param_path: Union[Unset, str] = UNSET,
        param_query: Union[Unset, str] = UNSET,
        ...
        client = self._client
        return parameters.get_same_name_multiple_locations_param.sync_detailed(
            client=client,
            param_path=param_path,
            param_query=param_query,
        )
...
class MyTestAPIClient:
    def __init__(self, base_url: Optional[str] = None, timeout: float = 5.0, token: Optional[str] = None):
        ...
        self.default = DefaultApi(self.connection)
        self.parameters = ParametersApi(self.connection)
...
class SyncMyTestAPIClient:
    def __init__(self, base_url: Optional[str] = None, timeout: float = 5.0, token: Optional[str] = None):
        ...
        self.default = SyncDefaultApi(self.connection)
        self.parameters = SyncParametersApi(self.connection)
